...
public class IncrementalStorageException extends Exception {
     ...
     */
    public IncrementalStorageException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public IncrementalStorageException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public IncrementalStorageException(Throwable cause) {
        super(cause);
    }
